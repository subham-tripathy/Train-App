		...
		<table style="border: none; font-family: monospace; color: ; font-size: 20px; width: max-content;">
			<tbody>
				<tr>
					...
					<td style="font-family: sans-serif; font-weight: bolder; text-align: center; font-size: 25px;">Book now</td>
				</tr>
			...
			foreach($result as $x){
				...
				echo "<td style='padding: 10px 15px;'><a href='BookTrains.php?tr_no=".$x['TR_NO']."'>Click to Book</a></td>";
				echo "</tr>";
			}
			?>
			</tbody>
...
?>
	...
	<section>
		...
		<form action="FareEnq.php" class="tab red" method="post">
			From Station: 
		...
		<br />
		<br /> <input type="submit" name="fareEnq" value=" SEARCH TRAIN "><br />
	</form>
	<br />
	</section>
<?php
